//
//  CSFPortfStockMonthLineViewController.swift
//  csfsamradar
//
...
class JSUMonthLineViewController: UIViewController {
    ...
    func loadData(){
        let model:JSUKLineMessage = readFile("monthLineData", ext: "json")
    ...
    override func viewDidLoad() {
        ...
        self.kLineView.monthLineLimit = 12
